 ...
 */
package com.india.adigha.test.setup;
...
import com.india.adigha.test.constants.AdighaTestConstants;
import com.india.adigha.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AdighaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/Adighatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/Adighatest/import/reviews.impex");
			...
			importImpexFile(context, "/Adighatest/import/cstickets.impex");
		}
	}
}
