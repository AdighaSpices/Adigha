...
/**
 * This is the extension manager of the Adighaservices extension.
 */
public class AdighaservicesManager extends GeneratedAdighaservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AdighaservicesManager.class);
	 ...
	 */
	public static AdighaservicesManager getInstance()
	{
		return (AdighaservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AdighaservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdighaservicesManager() // NOPMD 
	{
		LOG.debug("constructor of AdighaservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AdighaservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AdighaservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
