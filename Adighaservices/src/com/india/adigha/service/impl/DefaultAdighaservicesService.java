 ...
 */
package com.india.adigha.service.impl;
...
public class DefaultAdighaservicesService implements AdighaservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAdighaservicesService.class);
	...
	{
		return DefaultAdighaservicesService.class.getResourceAsStream("/Adighaservices/sap-hybris-platform.png");
	}
