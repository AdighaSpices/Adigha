 ...
 */
package com.india.adighabackoffice.jalo;
...
import com.india.adighabackoffice.constants.AdighabackofficeConstants;
 ...
 */
public class AdighabackofficeManager extends GeneratedAdighabackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdighabackofficeManager.class.getName());
	 ...
	 */
	public static AdighabackofficeManager getInstance()
	{
		return (AdighabackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AdighabackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdighabackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdighabackofficeManager called.");
		}
	}
