 ...
 */
package de.hybris.platform.adigha.hmc;
...
/**
 * Provides necessary meta information about the Adigha hmc extension.
 *
 *
 * @version ExtGen v4.1
 */
public class AdighaHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AdighaHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.adigha.hmc.locales";
