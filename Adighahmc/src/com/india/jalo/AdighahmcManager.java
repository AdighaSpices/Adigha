...
/**
 * This is the extension manager of the Adighahmc extension.
 */
public class AdighahmcManager extends GeneratedAdighahmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AdighahmcManager.class);
	 ...
	 */
	public static AdighahmcManager getInstance()
	{
		return (AdighahmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AdighahmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdighahmcManager() // NOPMD 
	{
		LOG.debug("constructor of AdighahmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AdighahmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AdighahmcManager called, current tenant: {}", getTenant().getTenantID());
	}
