...
public class DefaultAdighahmcService implements AdighahmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAdighahmcService.class);
	...
	{
		return DefaultAdighahmcService.class.getResourceAsStream("/Adighahmc/sap-hybris-platform.png");
	}
