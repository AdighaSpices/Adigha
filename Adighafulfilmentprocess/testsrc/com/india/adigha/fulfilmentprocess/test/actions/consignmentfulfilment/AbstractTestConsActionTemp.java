 ...
 */
package com.india.adigha.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AdighaFulfilmentProcessConstants.PARENT_PROCESS);
