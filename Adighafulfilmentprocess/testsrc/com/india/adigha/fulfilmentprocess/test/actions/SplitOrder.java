 ...
 */
package com.india.adigha.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AdighaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AdighaFulfilmentProcessConstants.PARENT_PROCESS);
