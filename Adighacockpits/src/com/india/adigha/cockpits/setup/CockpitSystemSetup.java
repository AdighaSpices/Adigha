 ...
 */
package com.india.adigha.cockpits.setup;
...
import com.india.adigha.cockpits.constants.AdighaCockpitsConstants;
 ...
 */
@SystemSetup(extension = AdighaCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AdighaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AdighaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AdighaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/Adighacockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
