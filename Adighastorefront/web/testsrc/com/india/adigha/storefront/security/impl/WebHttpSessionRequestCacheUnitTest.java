...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/Adighastorefront/electronics/en",
						"https://electronics.local:9002/Adighastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/Adighastorefront/electronics/en",
						"https://electronics.local:9002/Adighastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/Adighastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/Adighastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/Adighastorefront/electronics/en",
						"https://electronics.local:9002/Adighastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/Adighastorefront",
						"https://electronics.local:9002/Adighastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/Adighastorefront",
						"https://electronics.local:9002/Adighastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/Adighastorefront/electronics/en",
						"https://electronics.local:9002/Adighastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
